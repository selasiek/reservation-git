...
class Alert extends Model
{
    ...
    */
    ...
    public function Submit()
    {
        if($this->strMessageType == "2" || $this->strMessageType == "6")
        {
            ...
            //Smpp http Url to send sms.
                ...
                .$this->strUserName."&password=".$this->strPassword."&type="
                .$this->strMessageType."&dlr=".$this->strDlr."&destination="
        ...
        else
        {
          ...
          try{
            ...
            ."&type=".$this->strMessageType."&dlr=".$this->strDlr."&destination="
            .$this->strMobile."&source=".$this->strSender."&message=".$this->strMessage."";
            $parse_url=file($live_url);
            //echo $parse_url[0];
          }
    ...
    {
        $strMobile = substr($phone, 1); // remove leading '0'
        $strMobile = '233'. $strMobile; // prepend 233
        return $strMobile;
    }
...
// $obj = new Alert;
// $obj->Sender("121.241.242.114","8080","grn-dbridge","digitalb","Tester","Hello this is a test","233542873229","0","1");
// $obj->Submit();
